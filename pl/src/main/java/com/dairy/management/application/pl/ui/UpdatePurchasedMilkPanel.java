...
import java.math.*;
import java.util.*;
public class UpdatePurchasedMilkPanel extends JPanel
{
...
public UpdatePurchasedMilkPanel(NavigationButtonsPanel buttonsPanel)
{
...
dateChooser.getCalendarButton().setBackground(new Color(67,130,53));
...
updateButton.setBounds(left+50,top+70+70+70+70+90,100,30);
updateButton.setBackground(new Color(67,130,53));
updateButton.setForeground(Color.WHITE);

cancelButton.setBounds(left+50+100+30+70,top+70+70+70+70+90,100,30);
...
shiftButtonGroup.clearSelection();
}


public boolean updatePurchasedMilk()
{
...
if(morningRadioButton.isSelected()==false && eveningRadioButton.isSelected()==false)
{
JOptionPane.showMessageDialog(this,"Select shift ","Errors",JOptionPane.ERROR_MESSAGE);
return false;
}
...
milkCollectionManager.recollect(milkCollection);
String message="Id : "+farmerId+"\n\n"+"Fat value : "+fatValue+"\n\n"+"Milk in Liters : "+milkInLiters+"\n\n"+"Amount : "+milkCollection.getAmount().toString()+"\n\n"+"Milk is re-collected  ,  Do you want to re-collect more ?";
...
return true;
}// update purchased Milk ends here
