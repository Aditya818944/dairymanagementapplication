...
import java.math.*;
import java.util.*;
public class UpdateSoldMilkPanel extends JPanel
{
...
public UpdateSoldMilkPanel(NavigationButtonsPanel buttonsPanel)
{
...
buyerSaleManager.reSale(buyerSale);
String message="\n\nId : "+buyerId+"\n\n"+"Fat value : "+fatValue+"\n\n"+"Milk in Liters : "+milkInLiters+"\n\n"+"Amount : "+buyerSale.getAmount().toString()+"\n\n"+"Milk is re-sold ,  Do you want to re-sell more ?";
